...
popt, pcov = curve_fit(sigmoid, cum_x_axis, cum_intensity, maxfev=100000)

dn_parmas, dn_cov = curve_fit(double_norm, cum_x_axis, cum_intensity, maxfev=100000000)
...
fit_y =sigmoid(cum_x_axis, *popt)
#plt.plot(granular_x, double_norm(granular_x, *dn_parmas), label="Normal Fit of Data")
plt.plot(granular_x, sigmoid(granular_x, *popt), label="Polynomial Fit of Data")
...
plt.savefig("figures/low_verticle_intensity_change.png", bbox_inches='tight')
plt.clf()
